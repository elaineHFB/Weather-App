...
function hWidget(props) {
    return (
        ...
        <div>
            ...
            <div><span>{props.data['list'][4]['dt_txt'].split(' ')[1]}</span>   <span>{Math.roubnd(props.data['list'][4]['main']['temp'])}</span>*C <span>{props.data['list'][4]['weather'][0]['description']}</span>  <span>{props.data['list'][4]['main']['humidity']}</span>%  <span>{props.data['list'][4]['wind']['speed']}</span>mph <span>{props.data['list'][4]['wind']['deg']}</span>*   <span>{props.data['list'][4]['wind']['gust']}</span>m/s <span>{props.data['list'][4]['clouds']['all']}</span>%   <span>{props.data['list'][4]['visibilty']}</span></div>
        </div>
    )
}
